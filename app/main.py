...
async def security_headers(request:Request,call_next):
    ...
    return response
for router in [health_router,auth_router,portfolios_router,suitability_router,simulator_router,subscriptions_router,consents_router,activity_router,dashboard_router,positions_router,admin_router,manager_router]: app.include_router(router)
